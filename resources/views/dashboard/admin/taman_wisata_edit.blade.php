        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <form class="users" action="/dashboard/taman-wisata/edit" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input value="{{ $data_taman->thumbnail }}" type="file" name="thumbnail" class="form-control" id="thumbnail" placeholder="input your thumbnail here..">
                        ...
                        <div class="form-group" id="fasilitas-preview">
                            ...
                            <div class="mb-3">
                                ...
                                <input value="" type="text" name="fasilitas_text[]" class="form-control" id="fasilitas" placeholder="input your fasilitas here..">
